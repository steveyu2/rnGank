...
import { timeMsg, cutstr, randomColor } from "~/common/util";
...
export default class Android extends PureComponent {
  ...
  render() {
    ...
    let { publishedAt = "", who } = this.props;
            ...
            <View style={[styles.TopWrap]}>
              <Avatar
                ...
                overlayContainerStyle={{
                  backgroundColor: theme.gankIconStyle.color || this.randomColor
                }}
              />
              <Text
                style={[
                  styles.title,
                  { color: theme.gankTextStyle.color || "#000" }
                ]}
              >
                {desc}
              </Text>
              ...
              <View style={styles.bottomRightWrap}>
                <Badge
                  ...
                  containerStyle={[
                    ...
                    { backgroundColor: theme.gankBadgeStyle.color || mainColor }
                  ]}
                  textStyle={styles.bottomRightBadgeText}
                />
                <Text
                  style={[
                    styles.bottomRightTime,
                    { color: theme.gankTextStyle.color || "#000" }
                  ]}
                >
                  {publishedAt}
