...
import { FONT_SIZE, adaptUnits, TAB_HEIGHT } from "~/common/constants";
...
class MyScrollableTabBar extends PureComponent {
  render() {
    ...
    if (theme.tabContainerStyle.backgroundColor) {
      addStyle = [{ borderColor: theme.tabContainerStyle.backgroundColor }];
    }

    return (
      <ScrollableTabView
        tabBarBackgroundColor={
          theme.tabContainerStyle.backgroundColor || "#fff"
        }
        ...
        tabBarUnderlineStyle={[
          styles.underline,
          { backgroundColor: theme.lightText.color || mainColor }
        ]}
